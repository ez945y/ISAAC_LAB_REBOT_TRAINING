...
Pure-logic layers (no Isaac dependency, unit-testable):
    formation, robot_agent, mission, scheduler, teleop
...
from .ros_interface import RosTopics, SquadRosBridge, normalize_dispatch_command
from .scheduler import Dispatcher, Squad, split_evenly
from .teleop import Command, KeyboardConsole, help_text

__all__ = [
    "Formation", "slots",
    "Mission", "FormationMoveToArea",
    "AgentState", "LocomotionBackend", "RobotAgent", "velocity_command",
    "RosTopics", "SquadRosBridge", "normalize_dispatch_command",
    "Dispatcher", "Squad", "split_evenly",
    "Command", "KeyboardConsole", "help_text",
]
